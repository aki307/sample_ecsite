...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_tiny_slider_src_tiny_slider__ = __webpack_require__(15);
...
if ($('.my-slider').length) {
    var slider = Object(__WEBPACK_IMPORTED_MODULE_0__node_modules_tiny_slider_src_tiny_slider__["a" /* tns */])({
        container: '.my-slider',
        items: 1,
        slideBy: 'page',
        autoplay: true
...
// ページトップにスクロールする
$(document).ready(function () {
    $('#pagetop_screen').on('click', function (e) {
